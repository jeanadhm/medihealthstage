    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('doctor', 'Docteur'), ('patient', 'Patient')], max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('adresseHopital', models.CharField(blank=True, max_length=255, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='patients_created', to='users.doctor')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='rdv_created', to='users.doctor')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time', models.TimeField()),
                ('instructions', models.TextField(blank=True, null=True)),
                ('status', models.CharField(choices=[('En attente', 'En attente'), ('Validé', 'Validé'), ('Reporté', 'Reporté')], default='En attente', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='consultation_created', to='users.doctor')),
